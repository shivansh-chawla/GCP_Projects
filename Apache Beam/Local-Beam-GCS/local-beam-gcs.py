...
Delayed_time = (
p1
  | "Import Data time" >> beam.io.ReadFromText(r"C:\Users\chawl\Projects\GCP_Projects\Apache Beam\flights_sample.csv", skip_header_lines = 1)
...
Delayed_num = (
    p1
    | "Import Data" >> beam.io.ReadFromText(r"C:\Users\chawl\Projects\GCP_Projects\Apache Beam\flights_sample.csv", skip_header_lines = 1)
...
Delay_table = (
    ...
    | "Save to GCS" >> beam.io.WriteToText(r"gs://df-test-bucket/flights_output.csv")
)
